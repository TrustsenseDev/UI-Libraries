		...
		slider.Slider.InputBegan:Connect(function(input)
			if input.UserInputType == Enum.UserInputType.MouseButton1 then
				...
				while dragging do
					...
					library.Functions.Tween(slider.Slider.Bar.Fill.Circle.Circle, { BackgroundTransparency = 0 }, 0.1)
				...
				library.Functions.Tween(slider.Slider.Bar.Fill.Circle.Circle, { BackgroundTransparency = 1 }, 0.2)
			end
		end)
				...
				library.Functions.Tween(
					dropdown,
					{
						Size = UDim2.new(
							...
							0,
							(#list == 0 and 30)
								or 44 + math.clamp(#list, 0, 3) * 25 + ((math.clamp(#list, 0, 3) - 1) * 4)
						),
					},
					0.3
				)
			...
			library.Functions.Tween(
				dropdown,
				{
					Size = UDim2.new(
						...
						0,
						(entries == 0 and 30)
							or 44 + math.clamp(entries, 0, 3) * 25 + ((math.clamp(entries, 0, 3) - 1) * 4)
					),
				},
				0.3
			)
